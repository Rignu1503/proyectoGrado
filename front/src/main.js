...
const items = document.querySelector('.div_padre');
...
//creamos un div cn la clase row
...
// Crea un elemento del DOM a partir de los datos del item
function createDomElement(item){
    const itemHtml = `
        <div class="card_hijo" data-id=${item._id}>
                    <img class="item-image" src="${serverUrl}${imagesPath}${item.image}" alt="">
