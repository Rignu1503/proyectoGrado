//ESCUCHAMOS LOS EVENTOS QUE TENGAN la clase addtocart y llamamos la funcion addToCartClicked
...
//Extraemos informacion de los elementos que tiene las clases
function addToCartClicked(event) {
  const button = event.target;
  const item = button.closest('.card_hijo');
  ...
  //llamamos esta funcion y le pasamos los parametros
